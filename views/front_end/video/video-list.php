    ...
    <div class="container">
        ...
        <article class="row video-item">
            <div class="col-md-4">
                ...
                <p class="button-full"><a href="video.html" class="btn btn-theme btn-green"><i class="fa fa-play"></i> Watch the video <small <i class="fa fa-heart"></i></small></a></p>
            </div>
            <div class="col-md-8">
        ...
        <ul class="pagination">
            ...
            <li class="active"><a href="video-list.php">1 <span class="sr-only">(current)</span></a></li>
            <li><a href="#">2</a></li>
            <li><a href="#">3</a></li>
