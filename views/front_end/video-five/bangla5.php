    ...
    <section class="content content-light  videos-list videos-list-list">
        <div class="container">
            ...
            <article class="row video-item">
                <div class="col-md-4">
                    <a href="video-bn.php" class="video-prev video-prev-small"></a>
                    <p class="button-full"><a href="video-bn.php" class="btn btn-theme btn-green"><i class="fa fa-play"></i> Watch the video <small><i class="fa fa-heart"></i></small></a></p>
                </div>
                <div class="col-md-8">
                    <h3 class="video-title"><a href="video-bn.php">How to draw a painting</a></h3>
            ...
            <ul class="pagination">
                ...
                <li class="active"><a href="bangla.php">1 <span class="sr-only">(current)</span></a></li>
                <li><a href="#">2</a></li>
                <li><a href="#">3</a></li>
