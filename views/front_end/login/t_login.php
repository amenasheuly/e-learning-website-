    ...
    if($email&&$password){
        ...
        if(mysqli_num_rows($check) !=0){
            ...
            if($email == $db_email && $password == $db_password){
                ...
                header("Location: ../../admin-panel/teacher/user/index.php");
...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            ...
            <form class="login100-form validate-form" action="t_login.php" method="post">
                ...
                <div class="container-login100-form-btn">
                    ...
                    <button class="login100-form-btn"><a href="../teacherreg/teacherregistration.php">Register</a></button>
                </div>
            </form>
        </div>
    </div>
