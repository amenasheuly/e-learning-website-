        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    ...
                    <?php
                    $query = "SELECT * FROM t_class_material where id='".$_GET['id']."'";
                    ...
                    <div class="panel-body">
                           ...
                           <div class="col-sm-6 form-group">
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Description" name="des" value="<?php echo $des;?>" >
                            </div>
                            <div class="col-sm-12 form-group">
                                <label>Author</label>
                            ...
                            <div class="col-sm-12 form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Link" name="video" value="<?php echo $video;?>">
                            </div>
...
$video=$_GET['video'];
$file=$_GET['file'];
  $up_query= "UPDATE t_class_material SET date='$date',class='$class',subject='$subject',title='$title',des='$des',author='$author',video='$video',file='$file'WHERE id='$id'";
