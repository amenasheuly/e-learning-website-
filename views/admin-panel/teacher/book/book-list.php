...
<?php 
    $query =   "SELECT * FROM book WHERE t_email= '".$_SESSION['email']."'";
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="btn-group">
                            <a class="btn btn-success" href="add-book.php"> <i class="fa fa-plus"></i> Add Book </a>
                        </div>
                    </div>
...
// die();
    ...
    echo '<td>'.$subject.'</td>';
                                    ...
                                    echo "<td><a href='update-file.php?id=".$id."class=".$class."subject=".$subject."author=".$author."t_email=".$email."file=".$file."'>Edit</a></td>";
