...
<?php 
    $query ="SELECT * FROM assignment WHERE s_email= '".$_SESSION['email']."'";
            ...
            <div class="col-sm-12">
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="btn-group">
                            <a class="btn btn-success" href="add-ass.php"> <i class="fa fa-plus"></i> Add Assignment </a>
                        </div>
                    </div>
...
// die();
    ...
    echo "<td><a href='update-file.php?id=".$id."s_name=".$s_name."s_date=".$s_date."class=".$class."subject=".$subject."s_email=".$s_email."st_email=".$email."topics=".$topics."file=".$file."'>Edit</a></td>";
